...
//		ceil(실수 값) : 올림처리, 페이지에 게시글이 한개라도 있다면, 올림을 하여 해당 페이지를 표시하기 위함
...
//		실제 마지막 페이지는 전체 기시글 개수에서 amount를 나눠주게 된다. 하지만 1개의 게시글이 있더라도 페이지를 표현해야 하기 때문에
//		실수로 나누어 준 다음 소수점을 올림하여 피이지를  +1 해준다.
