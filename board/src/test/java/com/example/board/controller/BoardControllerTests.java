...
//				//getViewName() : 이동하게 될 페이지  getModelMap() : 해당 게시글의 정보
...
//				.param("bno", "42")).andReturn().getFlashMap());
//	}
...
//				//.andReturn().getModelAndView().getModelMap() : 컨트롤러에서 addAttribute로 썼을 때
